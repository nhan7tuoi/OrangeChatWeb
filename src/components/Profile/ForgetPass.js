            ...
            <Row justify='center'>
              ...
              <Col span={12} style={{ alignItems: 'center' }}>
                ...
                <div style={{ display: 'flex', alignItems: 'center', flexDirection: 'column' }}>
                  <input name='email' type='text' placeholder='Email' style={{ backgroundColor: '#2E2E2E', width: '60%', height: '60px', borderRadius: '10px', marginTop: '30px', fontSize: '18px', padding: '15px', color: '#FFF' }}></input>
                ...
                <Row justify='center'  >
                  <Col span={12} style={{ display: 'flex', justifyContent: 'center', flexDirection: 'column', alignItems: 'center' }}>
                    <Link to='/registercontinute'>
                      <Button style={{ width: '460px', height: '60px', fontSize: '24px', fontWeight: '800px', color: '#FFFFFF', backgroundColor: '#F24E1E', borderColor: '#F24E1E', marginTop: '50px', fontWeight: '600' }}>
                        Lấy lại mật khẩu
                      </Button>
                    </Link>
